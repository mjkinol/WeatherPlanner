...
public class AerisAdvancedWeatherSourceTest {
	...
	public void testGetLocations() {
		List<WeatherLocation> results = testSource.getLocations(new WeatherFilter("Atlanta,us", 50, 40, PrecipType.Rainy, 10, 500), TempUnit.Fahrenheit);
		List<WeatherLocation> expected = new ArrayList<WeatherLocation>();
		expected.add(new WeatherLocation("upland", "us", "Cloudy with Heavy Rain", WeatherIcon.Raining.getStaticPath(), WeatherIcon.Raining.getAnimatePath(), 47, 69, 50, TempUnit.Fahrenheit, 1898, false, 0));
		expected.add(new WeatherLocation("frankfort", "us", "Cloudy with Light Rain", WeatherIcon.Raining.getStaticPath(), WeatherIcon.Raining.getAnimatePath(), 31, 55, 47, TempUnit.Fahrenheit, 757, false, 0));
		expected.add(new WeatherLocation("philly wings f", "us", "Cloudy with Light Rain", WeatherIcon.Raining.getStaticPath(), WeatherIcon.Raining.getAnimatePath(), 36, 53, 50, TempUnit.Fahrenheit, 668, false, 0));
